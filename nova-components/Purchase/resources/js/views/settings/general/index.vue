            ...
            <card>
                <div class="flex border-b border-40 mb-2 p-2">
                    <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6 px-2">
                        ...
                        <input v-model="form['company.name']" class="w-full form-control form-input form-input-bordered">
                    </div>
                    <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6 mb-2 px-2">
                        <label class="inline-block text-80 pt-2 leading-tight">
                            Nit
                        </label>
                        <input v-model="form['company.nit']" class="w-full form-control form-input form-input-bordered">
                    </div>
                </div>
                <div class="w-full bg-gray-400 px-4 py-2 m-2">
